  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-links">
        ...
        <a href="#certifications" className="nav-btn">Certifications</a> 
        <a href="#education" className="nav-btn">Education</a>
        <a href="#contact" className="nav-btn">Contact</a>
        <a href="/c:\Users\gajen\Downloads\K_Jithendhar_Reddy_SDE 03-08-25.pdf" className="nav-btn resume" download>
          Resume
        </a>
      </div>
    </nav>
